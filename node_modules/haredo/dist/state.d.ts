...
export declare type Component = 'ConnectionManager' | 'RPC' | 'Consumer' | 'Publisher' | 'MessageManager';
export declare type Logger = (logItem: {
    component: Component;
    msg: string;
...
export declare const defaultState: <TMessage, TReply>() => Partial<HaredoChainState<TMessage, TReply>>;
