...
export declare type Omit<T extends {}, K extends keyof T> = Pick<T, Exclude<keyof T, K>>;
interface TypedEE<T> {
...
export declare type TypedEventEmitter<T> = TypedEE<T> & Omit<EventEmitter, keyof TypedEE<any>>;
export declare const typedEventToPromise: <T>(emitter: TypedEventEmitter<T>, event: keyof T) => Promise<any>;
export declare const makeEmitter: <T>() => TypedEventEmitter<T>;
export {};
